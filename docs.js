          ...
          data: [
            {
              ...
              english: {
                ...
                hadith:
                  'Hadith text in english, without the narrator',
                fullHadith:
              ...
              reference: {
                ...
                api: {
                  ...
                  hadithInBook:
                    'api link for this hadith in this book',
                },
                sunnahWebsite: {
              ...
              ahadith: [
                {
                  ...
                  arabic: {
                    hadithNarrated: 'hadith narrated in arabic',
                    hadith:
                      'Hadith text in arabic, without the narrator',
                    fullHadith:
                      'Full hadith text in arabic, including the narrator',
                    grade: 'grade of hadith in arabic',
                  },
                  reference: {
                    ...
                    hadithNumberInCollection:
                      'number of hadith in collection',
                    api: {
                      hadith: 'api link for this hadith',
                      book: 'api link for this book',
                      hadithInBook:
